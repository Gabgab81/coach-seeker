...
<<<<<<< HEAD
ActiveRecord::Schema.define(version: 2021_02_15_165340) do
=======

ActiveRecord::Schema.define(version: 2021_02_15_164546) do
...
>>>>>>> master
  ...
  create_table "coachings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["offer_id"], name: "index_coachings_on_offer_id"
    t.index ["user_id"], name: "index_coachings_on_user_id"
  end

  create_table "messages", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "coaching_id", null: false
    t.text "content"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  add_foreign_key "coachings", "offers"
